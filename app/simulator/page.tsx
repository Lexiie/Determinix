...
export default function SimulatorPage() {
  return (
    <main className="min-h-screen py-6 md:py-12 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl md:text-4xl font-bold text-white mb-6 md:mb-8 text-center">Transaction Simulator</h1>
